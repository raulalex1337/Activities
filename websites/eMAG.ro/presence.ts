...
enum ActivityAssets {
  Logo = 'https://s13emagst.akamaized.net/layout/ro/assets/images/logo/emag.svg',
  Cart = 'https://cdn-icons-png.flaticon.com/512/263/263142.png',
  Search = 'https://cdn-icons-png.flaticon.com/512/751/751381.png',
  Product = 'https://cdn-icons-png.flaticon.com/512/3081/3081559.png',
  Category = 'https://cdn-icons-png.flaticon.com/512/2942/2942813.png',
...
presence.on('UpdateData', async () => {
  ...
  if (privacyMode) {
    ...
    if (pathname === '/' || pathname === '/home') {
      ...
      const itemCount = document.querySelectorAll('.cart-item, .product-item').length;
